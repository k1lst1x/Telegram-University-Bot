...
SYSTEM_PROMPT = {
    ...
    "content": (
        ...
        "Видеообзор АУЭС: https://youtu.be/iQ2sPOv2nYg\n"
        "Инстаграм университета: https://www.instagram.com/energo.university\n\n"
        "Студенты Energo University могут участвовать в программе академической мобильности и уезжать учиться в зарубежные вузы по обмену.\n"
        "Вся актуальная информация о возможностях обучения за рубежом — в Telegram-канале департамента международного сотрудничества: https://t.me/+S_wZLvmq5T03OWQy\n\n"
        ...
        "📲 Все подробности — в приёмной комиссии Energo University: +7 707 260 05 33\n\n"
